...
\begin{enumerate}
    ...
    \item Выполнить обратные преобразования для $F^0_k$ и $F^1_k$, затем восстановить исходный сигнал.
\end{enumerate}
...
Векторы обратных преобразований по чётным и нечётным отсчётам вычисляются по формуле обратного ДПФ для векторов длины $8$:
\[
\hat y^0_j=\frac{1}{8}\sum_{k=0}^{7}F^0_k\exp\left(\frac{2\pi i k}{8}j\right),
\qquad
\hat y^1_j=\frac{1}{8}\sum_{k=0}^{7}F^1_k\exp\left(\frac{2\pi i k}{8}j\right).
\]
Исходный сигнал восстанавливается обратным объединением подвекторов:
\[
\hat y_{2j}=\hat y^0_j,\qquad \hat y_{2j+1}=\hat y^1_j.
\]
...
Векторы обратных преобразований по чётным и нечётным отсчётам:
\begin{table}[H]
\centering
\caption{Векторы $\hat y^0(j)$ и $\hat y^1(j)$.}
\small
\begin{tabular}{|c|c|c|}
\hline
$j$ & $\hat y^0(j)$ & $\hat y^1(j)$ \\ \hline
0 & $-0{,}780000$ & $-1{,}220000$ \\ \hline
1 & $-1{,}340000$ & $-1{,}390000$ \\ \hline
2 & $-1{,}420000$ & $-1{,}430000$ \\ \hline
3 & $-1{,}420000$ & $-1{,}410000$ \\ \hline
4 & $-1{,}370000$ & $-1{,}300000$ \\ \hline
5 & $-1{,}100000$ & $-0{,}100000$ \\ \hline
6 & $1{,}120000$ & $1{,}250000$ \\ \hline
7 & $1{,}330000$ & $1{,}360000$ \\ \hline
\end{tabular}
\end{table}

После объединения этих подвекторов восстановлен исходный сигнал. Максимальная погрешность восстановления составила $2{,}50\cdot10^{-15}$.
